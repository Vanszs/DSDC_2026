  ...
  return (
    <div className={cn("inline-flex items-center gap-1", className)}>
      ...
      <button
        ...
        className={cn(
          "flex h-8 items-center gap-1.5 rounded-lg border border-slate-200 bg-slate-50 px-2.5 text-xs font-medium transition-all select-none",
      ...
      >
        {isPdfBusy ? (
          <Loader2 className="h-3.5 w-3.5 animate-spin text-slate-700 dark:text-slate-200" />
        ...
        <span className="font-semibold text-slate-800 dark:text-slate-200">
          {isPdfBusy ? (pdfStatus.message ?? "PDF...") : "Unduh PDF"}
        </span>
        <span className="hidden sm:inline-flex items-center rounded-md bg-slate-200 px-1.5 py-0.2 text-[9px] font-mono font-bold text-slate-700 dark:bg-slate-800 dark:text-slate-300">
          .PDF
        </span>
      </button>
      ...
      >
        ...
        <span className="font-semibold text-slate-800 dark:text-slate-200">
          {isExcelBusy ? (excelStatus.message ?? "Excel...") : "Unduh Excel"}
        </span>
        <span className="hidden sm:inline-flex items-center rounded-md bg-emerald-100 px-1.5 py-0.2 text-[9px] font-mono font-bold text-emerald-800 dark:bg-emerald-950 dark:text-emerald-300">
          .XLSX
        </span>
      </button>
    </div>
