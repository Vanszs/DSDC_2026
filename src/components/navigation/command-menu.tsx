...
export const CommandMenu: React.FC<CommandMenuProps> = ({
  ...
  return (
    ...
    >
      <div className="w-full max-w-2xl overflow-hidden rounded-xl border border-slate-200 bg-white shadow-2xl dark:border-slate-800 dark:bg-[#0b111a] text-slate-900 dark:text-slate-100 animate-in zoom-in-95 duration-100 flex flex-col max-h-[75vh]">
        {/* Search Header */}
        <div className="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800 px-4 py-3 bg-slate-50/70 dark:bg-slate-900/50">
          ...
          <button
            ...
            className="rounded p-1 text-slate-500 hover:bg-slate-200 dark:hover:bg-slate-800 dark:text-slate-400"
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isSelected
                      ? "bg-emerald-50 dark:bg-emerald-950/50 border border-emerald-300/80 dark:border-emerald-800/80 text-slate-900 dark:text-slate-50"
                      : "hover:bg-slate-100 dark:hover:bg-slate-900/60 text-slate-700 dark:text-slate-300 border border-transparent"
                  )}
                >
        ...
        {/* Footer info */}
        <div className="border-t border-slate-200 dark:border-slate-800 px-4 py-2 bg-slate-50 dark:bg-slate-900/60 flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400 font-mono">
          <div className="flex items-center gap-2">
            <span className="rounded bg-slate-200 dark:bg-slate-800 px-1 py-0.5 text-[10px]">↑↓</span>
            <span>Navigasi</span>
            <span className="rounded bg-slate-200 dark:bg-slate-800 px-1 py-0.5 text-[10px]">ENTER</span>
            <span>Pilih</span>
            <span className="rounded bg-slate-200 dark:bg-slate-800 px-1 py-0.5 text-[10px]">ESC</span>
            <span>Tutup</span>
          </div>
