  ...
  return (
    <div className="relative w-full h-[100dvh] overflow-hidden flex flex-col bg-[#FAF8F5] text-slate-900 dark:bg-[#080C14] dark:text-slate-100 transition-colors duration-150">
      ...
      <main id="main-content" role="main" className="relative flex-1 w-full h-full overflow-hidden">
        ...
        <div className="absolute top-2.5 left-2.5 sm:top-4 sm:left-4 z-20 pointer-events-auto">
          <LiveClockBadge />
        </div>
        ...
        <div className="absolute top-2.5 right-2.5 sm:top-4 sm:right-4 z-20 flex items-center gap-1.5 sm:gap-2 pointer-events-auto">
          <div className="flex items-center gap-1 sm:gap-1.5 rounded-xl border border-slate-200 bg-white/95 p-1 sm:p-1.5 shadow-lg backdrop-blur-md dark:border-slate-800 dark:bg-[#080C14]/95">
            ...
            <button
              ...
              className="flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-lg border border-slate-200 dark:border-slate-800 p-1.5 sm:p-2 text-slate-700 bg-slate-50 hover:bg-slate-100 active:scale-95 dark:text-slate-300 dark:bg-[#0B0F19] dark:hover:bg-slate-800 transition-all shrink-0"
            >
              <RefreshCw
                className={`h-3 w-3 sm:h-3.5 sm:w-3.5 text-slate-700 dark:text-slate-300 ${
